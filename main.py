...
from trainers.clipping import train
...
def main(args):
    ...
    if mode == "train":
        ...
        out_dir = os.path.join(
            os.path.expanduser("~"), args.out_dir, args.run_name, uid
        )
...
if __name__ == "__main__":
    ...
    # type of module
    parser.add_argument(
        "--module", type=str, choices=["lare", "clipping", "both"], default="clipping"
    )

    # wandb arguments
    parser.add_argument(
        "--project", type=str, default="local", help="wandb project name"
    )
    parser.add_argument("--run_name", type=str, default="debug", help="wandb run name")
    parser.add_argument("--log_every", type=int, default=50, help="logging step")
    parser.add_argument("--logging", type=bool, default=False, help="online logging")

    # training/testing config args
    parser.add_argument(
        "--mode", type=str, choices=["train", "test", "both"], default="train"
    )
    ...
    parser.add_argument("--eval_every", type=int, default=50, help="Evaluation step")
    ...
    parser.add_argument(
        "--debug", type=bool, default=True, help="Debugging on few samples"
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=2,
        help="The class number of training dataset",
    )
    ...
    parser.add_argument(
        "--data_size", type=int, default=256, help="The image size for training."
    )

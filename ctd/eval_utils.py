...
def get_parsed_args(model_dir, dataset_name, num_ctx_tokens, dataset_path):
    ...
    parser.add_argument(
        "--root", type=str, default=dataset_path, help="path to dataset"
    )
    parser.add_argument(
        "--output-dir", type=str, default="../CoOp/outputs/", help="output directory"
    )
    parser.add_argument(
        "--resume",
        type=str,
    ...
    parser.add_argument(
        "--config-file",
        type=str,
        default="./configs/trainers/CoOp/vit_l14_ep2.yaml",
        help="path to config file",
    )
    parser.add_argument(
        "--dataset-config-file",
        type=str,
        default="./configs/datasets/" + str(dataset_name) + ".yaml",
    ...
    parser.add_argument(
        "--eval-only", default="True", action="store_true", help="evaluation only"
    )
    parser.add_argument(
        "--model-dir",
        type=str,
